...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        ...
        <img width="40 px" class="app-sidebar__user-avatar" src="{{ asset('images/user/'. Auth::user()->image) }}" alt="User Image">
        @endif
    ...
    <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item {{ request()->is('order*') ? 'active' : ''}}" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-cube"></i><span class="app-menu__label">Order</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                {{-- <li><a class="treeview-item" href="{{route('order.create')}}"><i class="icon fa fa-circle-o"></i> New Order</a></li>
